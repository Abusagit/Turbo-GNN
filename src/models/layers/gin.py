...
doc = """
GIN block: MLP-based message passing with post norm/activation/dropout/residual.
"""
    ...
    def __init__(
        ...
        **conv_kwargs: Any,
        ...
        Args:
            ...
            bias (bool): Use bias (applies to internal MLP where relevant).
            ...
            **conv_kwargs (Any): Extra kwargs passed to GIN conv (eps, train_eps, etc.).

        Returns:
            None
        """
        super().__init__()
        self.conv = create_conv_layer("gin", backend, in_channels, out_channels, bias=bias, **conv_kwargs)
    ...
    def forward(
        ...
        *,
        ...
        Args:
            ...
            edge_weight (Optional[torch.Tensor]): Typically unused in base GIN.
